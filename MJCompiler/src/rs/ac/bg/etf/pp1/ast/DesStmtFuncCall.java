...
public class DesStmtFuncCall extends DesignatorStatement {

    private Designator Designator;
    private ActualPars ActualPars;

    public DesStmtFuncCall (Designator Designator, ActualPars ActualPars) {
