...
public class MultipleConditionFacts extends ConditionTerm {

    private ConditionTerm ConditionTerm;
    private ConditionFact ConditionFact;

    public MultipleConditionFacts (ConditionTerm ConditionTerm, ConditionFact ConditionFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleConditionFacts(\n");
