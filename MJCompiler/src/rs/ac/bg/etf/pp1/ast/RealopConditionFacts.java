...
public class RealopConditionFacts extends ConditionFact {

    private Expr Expr;
    private Realop Realop;
    private Expr Expr1;

    public RealopConditionFacts (Expr Expr, Realop Realop, Expr Expr1) {
        this.Expr=Expr;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("RealopConditionFacts(\n");
